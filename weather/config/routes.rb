Rails.application.routes.draw do
  ...
  get 'weather/data/:location_id/:date' => 'data#location', location_id: /[A-Za-z\s]+/, date: /(\d{2})-(\d{2})-(\d{4})/ 
  get 'weather/data/:post_code/:date' => 'data#postcode', post_code: /3\d{3}/, date: /(\d{2})-(\d{2})-(\d{4})/    
